    ...
    public ReplyBean get() throws Exception {
        if (this.checkpermission("get")) {
            ...
            try {
                ...
                CompraBean oCompraBean = new CompraBean(id);
                oCompraBean = oCompraDao.get(oCompraBean, AppConfigurationHelper.getJsonMsgDepth());
                Gson gson = AppConfigurationHelper.getGson();
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(oCompraBean));
            } catch (Exception ex) {
    ...
    public ReplyBean remove() throws Exception {
        if (this.checkpermission("remove")) {
            ...
            try {
                ...
                CompraDao oCompraDao = new CompraDao(oConnection);
                data = JsonMessage.getJsonExpression(200, (String) oCompraDao.remove(id).toString());
                oConnection.commit();
            } catch (Exception ex) {
                if (oConnection != null) {
    ...
    public ReplyBean set() throws Exception {
        if (this.checkpermission("set")) {
            ...
            try {
                ...
                oCompraBean = AppConfigurationHelper.getGson().fromJson(jason, oCompraBean.getClass());
                if (oCompraBean != null) {
    ...
    public ReplyBean getall() throws Exception {
        if (this.checkpermission("getall")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                CompraDao oCompraDao = new CompraDao(oConnection);
                ArrayList<CompraBean> arrBeans = oCompraDao.getAll(alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
    ...
    public ReplyBean getpage() throws Exception {
        if (this.checkpermission("getpage")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                CompraDao oCompraDao = new CompraDao(oConnection);
                List<CompraBean> arrBeans = oCompraDao.getPage(intRegsPerPag, intPage, alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(arrBeans));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
    ...
    public ReplyBean getcount() throws Exception {
        if (this.checkpermission("getcount")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                CompraDao oCompraDao = new CompraDao(oConnection);
                data = JsonMessage.getJsonExpression(200, Long.toString(oCompraDao.getCount(alFilter)));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
            } finally {
...
//            }
//            oConnection.close();
//            return new ReplyBean(200, JsonMessage.getJsonExpression(200, oCompraBean.getContenido()));
//        } else {
//            return new ReplyBean(401, JsonMessage.getJsonMsg(401, "Unauthorized"));
//        }
//    }
