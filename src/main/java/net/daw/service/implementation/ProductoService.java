    ...
    public ReplyBean get() throws Exception {
        if (this.checkpermission("get")) {
            ...
            try {
                ...
                oProductoBean = oProductoDao.get(oProductoBean, AppConfigurationHelper.getJsonMsgDepth());
                Gson gson = AppConfigurationHelper.getGson();
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(oProductoBean));
            } catch (Exception ex) {
    ...
    public ReplyBean remove() throws Exception {
        if (this.checkpermission("remove")) {
            ...
            try {
                ...
                ProductoDao oProductoDao = new ProductoDao(oConnection);
                data = JsonMessage.getJsonExpression(200, (String) oProductoDao.remove(id).toString());
                oConnection.commit();
            } catch (Exception ex) {
                if (oConnection != null) {
    ...
    public ReplyBean getall() throws Exception {
        if (this.checkpermission("getall")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                ProductoDao oProductoDao = new ProductoDao(oConnection);
                ArrayList<ProductoBean> arrBeans = oProductoDao.getAll(alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
    ...
    public ReplyBean getpage() throws Exception {
        if (this.checkpermission("getpage")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                ProductoDao oProductoDao = new ProductoDao(oConnection);
                List<ProductoBean> arrBeans = oProductoDao.getPage(intRegsPerPag, intPage, alFilter, hmOrder, AppConfigurationHelper.getJsonMsgDepth());
                data = JsonMessage.getJsonExpression(200, AppConfigurationHelper.getGson().toJson(arrBeans));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
    ...
    public ReplyBean getcount() throws Exception {
        if (this.checkpermission("getcount")) {
            ...
            try {
                ...
                oConnection = oDataConnectionSource.newConnection();
                ProductoDao oProductoDao = new ProductoDao(oConnection);
                data = JsonMessage.getJsonExpression(200, Long.toString(oProductoDao.getCount(alFilter)));
            } catch (Exception ex) {
                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
                throw new Exception();
            } finally {
...
//                oProductoBean = new ProductoBean(id);
//                ProductoDao oProductoDao = new ProductoDao(oConnection);
//                oProductoBean = oProductoDao.get(oProductoBean, AppConfigurationHelper.getJsonMsgDepth());
//            } catch (Exception ex) {
//                Log4j.errorLog(this.getClass().getName() + ":" + (ex.getStackTrace()[0]).getMethodName(), ex);
...
//            }
//            oConnection.close();
//            return new ReplyBean(200, JsonMessage.getJsonExpression(200, oProductoBean.getContenido()));
//        } else {
//            return new ReplyBean(401, JsonMessage.getJsonMsg(401, "Unauthorized"));
//        }
//    }
